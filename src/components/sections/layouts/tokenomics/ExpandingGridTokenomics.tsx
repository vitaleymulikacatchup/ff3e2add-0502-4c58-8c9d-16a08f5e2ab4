...
import { getFunAndTrendyTokenomicsStyle } from "../../styles/tokenomics/expandingGridTokenomics/funAndTrendy";
import { getFuturisticTokenomicsStyle } from "../../styles/tokenomics/expandingGridTokenomics/futuristicAndOutOfBox";
import { getBrainRotTokenomicsStyle } from "../../styles/tokenomics/expandingGridTokenomics/brainRot";
...
const Tokenomics = ({
  ...
  const style: TokenomicsStyle = getThemeStyle(theme, {
    ...
    brainRot: getBrainRotTokenomicsStyle,
  });
  return (
    <section
