...
import { getBrainRotImageFAQStyle } from "../../styles/faq/image/brainRot";
...
const ImageFAQ = memo(function ImageFAQ({
  ...
  const style: ImageFAQStyle = getThemeStyle(theme, {
    ...
    brainRot: getBrainRotImageFAQStyle,
  });
  return (
    <section
      className={cls(
    ...
    >
      ...
      <div className={cls("relative z-10 w-full", style.section.className)}>
