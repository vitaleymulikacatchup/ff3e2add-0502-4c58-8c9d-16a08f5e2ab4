...
import { getBrainRotHowToBuyStyle2D } from "../../styles/howtobuy/2DRevealHTB/brainRot";
...
import { getBrainRotMinimalHowToBuyStyle2D } from "../../styles/howtobuy/2DHTB/brainRot";
...
const HowToBuy2D = ({ variant = "reveal" }: HowToBuy2DProps) => {
      ...
      <div className="max-w-[var(--width-100)] md:px-[var(--width-10)] mx-auto relative z-10 flex flex-col gap-6 md:gap-12">
        ...
        {variant === "reveal" && style.bento && (
          <BentoHoverInfoReveal
            ...
            itemContentClassName={style.bento.itemContentClassName}
            itemTitleClassName={style.bento.itemTitleClassName}
            itemDescriptionClassName={style.bento.itemDescriptionClassName}
          />
        )}
        {variant === "simple" && style.simpleBento && (
          <SimpleHowToBuyBento
