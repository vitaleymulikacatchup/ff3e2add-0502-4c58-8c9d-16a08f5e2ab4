...
import { getFunAndTrendyHeroStyle } from "../../styles/hero/frameHero/funAndTrendy";
import { getFuturisticHeroStyle } from "../../styles/hero/frameHero/futuristicAndOutOfBox";
import { getBrainRotSimpleHeroStyle } from "../../styles/hero/frameHero/brainRot";
...
const FrameHero = ({
  ...
  const style: SimpleHeroStyle = getThemeStyle(theme, {
    ...
    brainRot: getBrainRotSimpleHeroStyle,
  });
  return (
    <>
      <section
      ...
      >
        ...
        >
          {style.section.sideGlowGradient ? (
            ...
            (backgroundImage || style.section.imageSrc) && (
              <div className={style.section.imageContainerClassName}>
                <Image
                  src={backgroundImage || style.section.imageSrc!}
...
FrameHero.displayName = "FrameHero";

export default memo(FrameHero);
