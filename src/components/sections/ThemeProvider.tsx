...
export function getThemeStyle<T>(
  ...
  styleGetters: {
    ...
    brainRot?: (colorTemplate: ColorTemplate) => T;
  }
): T {
  const getter = styleGetters[theme.styleVariant];
  if (!getter) {
    return styleGetters.funAndTrendy(theme.colorTemplate);
  }
  return getter(theme.colorTemplate);
}
