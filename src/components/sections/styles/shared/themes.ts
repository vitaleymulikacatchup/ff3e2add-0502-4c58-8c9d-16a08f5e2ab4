import { Barlow, Antonio, DM_Sans, Inter, Luckiest_Guy, Press_Start_2P, Audiowide, Doto } from 'next/font/google';
...
export const brainRotTheme = {
    ...
    text: {
        ...
        bodyClass: '!font-black uppercase',
        white: 'text-white'
    },
    animations: {
        duration: 0.8,
    ...
    spacing: {
        sectionPadding: 'py-20 md:py-30',
        gap: 'gap-6 md:gap-8',
        containerGap: 'flex flex-col gap-6 md:gap-8'
    },
    borders: {
        button: 'border-2',
    ...
    buttons: {
        primary: {
            ...
            text: 'text-black',
            hoverText: '',
            className: 'h-12 px-8 border-2 rounded-none',
            contentClassName: `!text-base md:!text-xl font-black uppercase ${doto.className}`
        },
        secondary: {
            base: 'bg-black',
            hover: '',
    ...
    description: {
        className: `text-base md:text-xl font-extrabold uppercase ${doto.className}`
    },
    heading: {
