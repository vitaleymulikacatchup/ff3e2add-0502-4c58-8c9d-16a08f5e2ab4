...
export const funAndTrendyColors = {
  1: {
    ...
    patternGradient:
      "bg-gradient-to-t from-fun-template-1-secondary to-red-500",
...
export const brainRotColors = {
  1: {
    primary: "bg-brain-rot-template-1-primary",
    secondary: "bg-brain-rot-template-1-secondary",
    tertiary: "bg-brain-rot-template-1-tertiary",
    button: "bg-brain-rot-template-1-secondary",
    buttonHover: "after:bg-black",
    buttonHoverText: "after:text-white",
    patternGradient: "bg-gradient-to-br from-black to-gray-800",
    timelineActive: "bg-white",
    timelineInactive: "bg-white/20",
    cardActive: "bg-brain-rot-template-1-secondary",
    cardInactive: "bg-white",
    textPrimary: "text-black",
    textSecondary: "text-white",
    border: "border-black",
  ...
  2: {
    primary: "bg-brain-rot-template-2-primary",
    secondary: "bg-brain-rot-template-2-secondary",
    tertiary: "bg-brain-rot-template-2-tertiary",
    button: "bg-brain-rot-template-2-secondary",
    buttonHover: "after:bg-black",
    buttonHoverText: "after:text-white",
    patternGradient: "bg-gradient-to-br from-black to-gray-800",
    timelineActive: "bg-white",
    timelineInactive: "bg-white/20",
    cardActive: "bg-brain-rot-template-2-secondary",
    cardInactive: "bg-white",
    textPrimary: "text-black",
    textSecondary: "text-white",
    border: "border-black",
...
export function getBrainRotColors(template: ColorTemplate) {
  return brainRotColors[template];
}
